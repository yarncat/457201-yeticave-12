          ...
          <div class="lot-item__state">
            ...
            <div class="lot-item__cost-state">
              ...
              <div class="lot-item__min-cost">
                Мин. ставка <span><?=isset($lot['rate']) ? formatSum($lot['rate'] + $lot['step_rate']) . ' p' : formatSum($lot['start_price'] + $lot['step_rate']) . ' p'; ?></span>
              </div>
            </div>
			...
			<form class="lot-item__form" action="lot.php?id=<?= $lot['id']; ?>" method="post" autocomplete="off">
              <p class="lot-item__form-item form__item <?=isset($errors) ? "form__item--invalid" : ""; ?>">
                ...
                <input id="cost" type="text" name="cost" placeholder="<?=isset($lot['rate']) ? formatSum($lot['rate'] + $lot['step_rate']) . ' p' : formatSum($lot['start_price'] + $lot['step_rate']) . ' p'; ?>">
