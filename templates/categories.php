  <main>
    ...
    <div class="container">
      ...
      <ul class="pagination-list">
        <li class="pagination-item pagination-item-prev"><a href="categories.php?id=<?=htmlspecialchars($_GET['id']); ?>&page=<?=($currentPage <= 1) ? $currentPage = 1 : $currentPage - 1; ?>">Назад</a></li>
        ...
        <?php endforeach; ?>
        <li class="pagination-item pagination-item-next"><a href="categories.php?id=<?=htmlspecialchars($_GET['id']); ?>&page=<?=($currentPage >= $pagesCount) ? $currentPage = $pagesCount : $currentPage + 1; ?>">Вперед</a></li>
      </ul>
      <?php endif; ?>
    </div>
  </main>
