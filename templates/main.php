      ...
      <?php foreach ($items as $item): ?>
        <li class="lots__item lot">
          ...
          <div class="lot__info">
            ...
            <h3 class="lot__title"><a class="text-link" href="lot.php?id=<?=$item['id']; ?>"><?=htmlspecialchars($item['lot_name']); ?></a></h3>
            <div class="lot__state">
              <div class="lot__rate">
              <?php if (isset($item['rate'])): ?>
                <span class="lot__amount"><?=$item['count'] . ' ' . get_noun_plural_form($item['count'], 'ставка', 'ставки', 'ставок'); ?></span>
                <span class="lot__cost"><?=formatSum(htmlspecialchars($item['rate'])); ?></span>                
              <?php else: ?>
